...
"stage": {
    ...
    content: {
            dom: [
            {
                ...
                fill: ["rgba(0,0,0,0)",im+"historia.png",'0px','0px']
            },
            {
                id: 'servicios',
                type: 'rect',
    ...
    timelines: {
        "Default Timeline": {
            ...
            autoPlay: true,
            timeline: [
                { id: "eid23", tween: [ "style", "${_servicios}", "top", '106px', { fromValue: '106px'}], position: 0, duration: 0 },
                { id: "eid13", tween: [ "style", "${_vinculacionCopy}", "left", '473px', { fromValue: '473px'}], position: 0, duration: 0 },
                { id: "eid19", tween: [ "style", "${_vinculacionCopy}", "top", '106px', { fromValue: '106px'}], position: 0, duration: 0 },
                { id: "eid24", tween: [ "style", "${_vinculacion}", "top", '106px', { fromValue: '106px'}], position: 0, duration: 0 },
                { id: "eid21", tween: [ "style", "${_Ideas}", "top", '106px', { fromValue: '106px'}], position: 0, duration: 0 },
                { id: "eid17", tween: [ "style", "${_serviciosCopy}", "top", '106px', { fromValue: '106px'}], position: 0, duration: 0 },
