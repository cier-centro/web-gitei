...
"stage": {
    ...
    content: {
            dom: [
            {
                id: '_4Publicaciones',
                type: 'image',
                rect: ['-99px', '0px','1271px','1180px','auto', 'auto'],
                clip: ['rect(0px 1128px 1180px 97px)'],
                fill: ["rgba(0,0,0,0)",im+"4.Publicaciones.png",'0px','0px']
            },
            {
                id: 'servicios',
                type: 'rect',
    ...
    states: {
        "Base State": {
            ...
            "${__4Publicaciones}": [
                ["style", "top", '0px'],
                ["style", "left", '-99px'],
                ["style", "clip", [0,1128,1180,97], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_serviciosCopy}": [
