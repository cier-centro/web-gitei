...
"stage": {
    ...
    content: {
            dom: [
            {
                id: '_7Vinculacin_a_proyectos',
                type: 'image',
                rect: ['-95px', '0px','1271px','1063px','auto', 'auto'],
                clip: ['rect(0px 1119px 1063px 94px)'],
                fill: ["rgba(0,0,0,0)",im+"7.Vinculaci%C3%B3n%20a%20proyectos.png",'0px','0px']
            },
            {
                id: 'menu2',
                type: 'rect',
            ...
            },
            {
                id: 'Rectangle',
                type: 'rect',
                rect: ['17px', '281px','150px','36px','auto', 'auto'],
                cursor: ['pointer'],
            ...
            },
            {
                id: 'RectangleCopy',
                type: 'rect',
                rect: ['185px', '281px','141px','36px','auto', 'auto'],
                cursor: ['pointer'],
                fill: ["rgba(192,192,192,0.00)"],
                stroke: [0,"rgba(0,0,0,1)","none"]
            },
            {
                id: 'RectangleCopy2',
                type: 'rect',
                rect: ['339px', '281px','141px','36px','auto', 'auto'],
                cursor: ['pointer'],
                fill: ["rgba(192,192,192,0.00)"],
                stroke: [0,"rgba(0,0,0,1)","none"]
            },
            {
                id: 'Rectangle2',
                type: 'rect',
                rect: ['314px', '110px','175px','36px','auto', 'auto'],
                opacity: 0.2,
    ...
    states: {
        "Base State": {
            ...
            "${__7Vinculacin_a_proyectos}": [
                ["style", "top", '0px'],
                ["style", "left", '-95px'],
                ["style", "clip", [0,1119,1063,94], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_RectangleCopy2}": [
