...
"stage": {
    ...
    content: {
            dom: [
            {
                ...
                clip: ['rect(0px 1123px 1063px 96px)'],
    ...
    states: {
        "Base State": {
            ...
            "${__6Ingreso_a_clientes}": [
                ["style", "top", '0px'],
                ["style", "left", '-97px'],
                ["style", "clip", [0,1123,1063,96], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_Stage}": [
    ...
    timelines: {
        "Default Timeline": {
            ...
            autoPlay: true,
            timeline: [
                { id: "eid5", tween: [ "style", "${_vinculacionCopy}", "left", '469px', { fromValue: '469px'}], position: 0, duration: 0 },
                { id: "eid3", tween: [ "transform", "${_vinculacionCopy}", "scaleX", '0.79213', { fromValue: '0.79213'}], position: 0, duration: 0 }            ]
        }
    }
},
"aulas": {
