        ...
        <div class="row education-trends">
            <div class="col-xs-12">
                <ul class="nav nav-tabs">
                    ...
                    <li><a data-toggle="tab" href="#trends">Tendencias Educativas</a></li>
                    <li><a data-toggle="tab" href="#alliance">Alianzas</a></li>
                </ul>
                <div class="tab-content">
                  <div id="services" class="row tab-pane fade in active">
                    <?php
                         $index = 0;
                  ...
                  <div id="trends" class="row tab-pane fade">
                      <?php
                           $index = 0;
                    ...
                    <div id="alliance" class="row tab-pane fade">
                      <?php
                           $index = 0;
                           $postslist = get_posts("category_name=Alianzas&orderby=title&order=asc");
                           foreach ($postslist as $post) : setup_postdata($post);
                           $subtitulo = get_post_meta($post->ID, 'subtitulo', true);
                           $urlPost = get_post_meta($post->ID, 'url', true);
                           $index++;
