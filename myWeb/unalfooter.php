<footer class="row clear unal-footer">
  ...
  <div class="col-md-4 col-lg-4 col-sm-4 col-xs-4 col-xxs-12 footer-info">
    <p class="col-sm-12 col-md-6 contacto">
      <b>Contacto página web:</b><br />Palacio de San Francisco<br /> Avenida Jiménez Nº 7-56 <br /> Bogotá D.C., Colombia<br /> (+57 1) 316 5000 Ext. 11156
    </p>
    <p class="col-sm-12 col-md-6 derechos">
      &copy; Copyright 2014<br /> Algunos derechos reservados.<br />
      <a title="Comuníquese con el administrador de este sitio web" href="mailto:info@gitei.edu.co">info@gitei.edu.co</a><br />
      <!--Comentado por GITEI
  ...
  <div class="col-md-2 col-lg-2 col-sm-2 col-xs-12 logos">
    <div class="col-xs-6 col-sm-12 col-md-6 no-padding">
      <a class="col-xs-6 col-sm-12" href="http://www.orgulloun.unal.edu.co">
        <img class="hidden-print" alt="Orgullo UN" src="<?php bloginfo('template_url')?>/img/log_orgullo.png" width="78" height="21" />
        <img class="visible-print" alt="Orgullo UN" src="<?php bloginfo('template_url')?>/img/log_orgullo_black.png" width="94" height="37" />
      </a>

      <a class="col-xs-6 col-sm-12 imgAgencia" href="http://www.agenciadenoticias.unal.edu.co/inicio.html">
        <img class="hidden-print" alt="Agencia de noticias" src="<?php bloginfo('template_url')?>/img/log_agenc.png" width="94" height="25" />
        <img class="visible-print" alt="Agencia de noticias" src="<?php bloginfo('template_url')?>/img/log_agenc_black.png" width="94" height="37" />
      </a>
    </div>
    <div class="col-xs-6 col-sm-12 col-md-6 no-padding">
      <a class="col-xs-6 col-sm-12" href="https://www.sivirtual.gov.co/memoficha-entidad/-/entidad/T0356">
        <img alt="Trámites en línea" src="<?php bloginfo('template_url')?>/img/log_gobiern.png" width="67" height="51" />
      </a>

      <a class="col-xs-6 col-sm-12" href="http://www.contaduria.gov.co/">
        <img alt="Contaduría general de la republica" src="<?php bloginfo('template_url')?>/img/log_contra.png" width="67" height="51" />
      </a>
    </div>
