<div id="unalServices">
  ...
  <ul class="dropdown-menu">
    <li>
      <a href="http://correo.unal.edu.co" target="_blank"><img src="<?php bloginfo('template_url')?>/img/icnServEmail.png" width="32" height="32" alt="Correo Electrónico">Correo Electrónico</a>
    </li>
    <li>
      <a href="https://dninfoa.unal.edu.co" target="_blank"><img src="<?php bloginfo('template_url')?>/img/icnServSia.png" width="32" height="32" alt="Dirección Nacional de Información Académica">DNINFOA - SIA</a>
    </li>
    <li>
      <a href="http://bibliotecas.unal.edu.co" target="_blank"><img src="<?php bloginfo('template_url')?>/img/icnServLibrary.png" width="32" height="32" alt="Biblioteca">Bibliotecas</a>
    </li>
    <li>
      <a href="http://personal.unal.edu.co" target="_blank"><img src="<?php bloginfo('template_url')?>/img/icnServCall.png" width="32" height="32" alt="Convocatorias">Convocatorias</a>
    </li>
    <li>
      <a href="http://identidad.unal.edu.co"><img src="<?php bloginfo('template_url')?>/img/icnServIdentidad.png" width="32" height="32" alt="Identidad U.N.">Identidad U.N.</a>
    </li>
  </ul>
</div>
<header id="unalTop">
  <div class="logo">
    <a href="http://unal.edu.co">
      ...
      <svg width="93%" height="93%">
        <image xlink:href="<?php bloginfo('template_url')?>/img/escudoUnal.svg" width="100%" height="100%" class="hidden-print" />
      </svg>

      <!--<![endif]-->
      <!--[if lt IE 9]>
  <img src="<?php bloginfo('template_url')?>/img/escudoUnal.png" width="93%" height="auto" class="hidden-print"/>
<![endif]-->
      <img src="<?php bloginfo('template_url')?>/img/escudoUnal_black.png" class="visible-print" />
    </a>
  </div>
  <div class="seal">
    <img class="hidden-print" alt="Escudo de la República de Colombia" src="<?php bloginfo('template_url')?>/img/sealColombia.png" width="66" height="66" />

    <img class="visible-print" alt="Escudo de la República de Colombia" src="<?php bloginfo('template_url')?>/img/sealColombia_black.png" width="66" height="66" />
  </div>
  <div class="firstMenu">
    ...
    <ul class="socialLinks hidden-xs">
      <li>
        <a href="https://www.facebook.com/GITEIUnal/" target="_blank" class="facebook" title="Página oficial en Facebook"></a>
      </li>
      <li>
        <a href="https://twitter.com/giteiunal" target="_blank" class="twitter" title="Cuenta oficial en Twitter"></a>
      </li>
      <li>
        <a href="https://www.youtube.com/channel/UC2u3YxV-FrnRe2pw4bpj1NQ" target="_blank" class="youtube" title="Canal oficial de Youtube"></a>
      </li>
      <li>
  ...
  <div id="bs-navbar" class="navbar-collapse collapse navigation">
    <div class="site-url">
      <a href="http://gitei.unal.edu.co/">gitei.unal.edu.co</a>
    </div>
    <div class="buscador">
    ...
    <div class="mainMenu">
      ...
      <div class="btn-group"><a href="index.html#" class="btn btn-default dropdown-toggle">Item menu ejemplo 2</a><span class="caret-right"></span></div>
      -->
      <div class="btn-group">
    ...
    <div class="btn-group hidden-sm hidden-md hidden-lg hidden-print">
      <div class="btn btn-default dropdown-toggle" data-toggle="dropdown" id="unalOpenMenuServicios" data-target="#unalServices">Servicios<span class="caret"> </span>
      </div>
    </div>
    <!--Comentado por GITEI
    <div class="btn-group hidden-sm hidden-md hidden-lg hidden-print">
