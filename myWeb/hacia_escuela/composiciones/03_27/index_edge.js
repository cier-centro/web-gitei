...
"slide_1": {
    ...
    content: {
            dom: [
                ...
                {
                    rect: ['0', '93px', '1304px', '596px', 'auto', 'auto'],
                    type: 'image',
                    id: 'C_txt',
                    display: 'none',
                ...
                {
                    rect: ['0', '183px', '1304px', '596px', 'auto', 'auto'],
                    type: 'image',
                    id: 'B_txt',
                    display: 'none',
                    clip: ['rect(0px 280px 138.66650390625px 0px)'],
                ...
                {
                    rect: ['0', '273px', '1304px', '596px', 'auto', 'auto'],
                    type: 'image',
                    id: 'A_txt',
                    display: 'none',
                    clip: ['rect(0px 280px 138.66650390625px 0px)'],
                ...
                {
                    rect: ['0px', '273px', '1304px', '596px', 'auto', 'auto'],
                    type: 'image',
                    id: 'a',
                    display: 'none',
                ...
                {
                    rect: ['0px', '183px', '1304px', '596px', 'auto', 'auto'],
                    type: 'image',
                    id: 'b',
                    display: 'none',
                ...
                {
                    rect: ['0px', '93px', '1304px', '596px', 'auto', 'auto'],
                    type: 'image',
                    id: 'c',
                    display: 'none',
                ...
                {
                    rect: ['192px', '510px', '919px', '79px', 'auto', 'auto'],
                    type: 'rect',
                    id: 'hsC',
                ...
                {
                    rect: ['192px', '417px', '919px', '79px', 'auto', 'auto'],
                    type: 'rect',
                    id: 'hsB',
                    stroke: [0, 'rgb(0, 0, 0)', 'none'],
                    cursor: ['pointer'],
                ...
                {
                    rect: ['192px', '324px', '919px', '79px', 'auto', 'auto'],
                    type: 'rect',
                    id: 'hsA',
                    stroke: [0, 'rgb(0, 0, 0)', 'none'],
                    cursor: ['pointer'],
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid2488", tween: [ "style", "${_C_txt}", "display", 'block', { fromValue: 'none'}], position: 2250, duration: 0, easing: "easeOutBack" },
                { id: "eid2494", tween: [ "style", "${_B_txt}", "clip", [225,1303,322.66650390625,0], { valueTemplate: 'rect(@@0@@px @@1@@px @@2@@px @@3@@px)', fromValue: [223,280,319.66650390625,0]}], position: 2000, duration: 750, easing: "easeOutQuad" },
                { id: "eid2526", tween: [ "style", "${_c}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
                { id: "eid2491", tween: [ "style", "${_B_txt}", "display", 'block', { fromValue: 'none'}], position: 1500, duration: 0, easing: "easeOutBack" },
                { id: "eid2528", tween: [ "style", "${_a}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
                { id: "eid2485", tween: [ "transform", "${_A_txt}", "scaleY", '1', { fromValue: '0'}], position: 750, duration: 500, easing: "easeOutBack" },
                { id: "eid2475", tween: [ "style", "${_ABC01}", "top", '37px', { fromValue: '-34px'}], position: 0, duration: 750, easing: "easeOutQuad" },
                { id: "eid2527", tween: [ "style", "${_b}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
                { id: "eid2481", tween: [ "style", "${_A_txt}", "display", 'block', { fromValue: 'none'}], position: 750, duration: 0, easing: "easeOutBack" },
                ...
                { id: "eid2489", tween: [ "style", "${_C_txt}", "clip", [405,1303,504.66650390625,0], { valueTemplate: 'rect(@@0@@px @@1@@px @@2@@px @@3@@px)', fromValue: [410,280,504.66650390625,0]}], position: 2750, duration: 750, easing: "easeOutQuad" },
