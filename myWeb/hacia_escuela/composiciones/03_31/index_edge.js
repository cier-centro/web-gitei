...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'txt',
                type: 'image',
                rect: ['5', '121px','1304px','596px','auto', 'auto'],
            ...
            },
            {
                id: 'fondo',
                type: 'image',
                rect: ['0px', '95px','1304px','596px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'none',
                type: 'image',
                rect: ['94px', '178px','1304px','596px','auto', 'auto'],
                clip: ['rect(166.666748046875px 468px 486.6669921875px 154.666015625px)'],
                fill: ["rgba(0,0,0,0)",im+"F1_D2.png",'0px','0px']
            },
            {
                id: 'bt_audio',
                type: 'rect',
                rect: ['501px', '219px','auto','auto','auto', 'auto'],
                title: 'Au1'
            },
            {
                id: 'per',
                type: 'rect',
                rect: ['98px', '59px','auto','auto','auto', 'auto'],
                clip: ['rect(-33.73828125px 587.2745971679688px 636.5899047851563px -29.78448486328125px)'],
            ...
            },
            {
                ...
                type: 'audio',
                tag: 'audio',
                rect: ['1482', '219','320px','45px','auto', 'auto'],
                source: ['media/F1_E5_D31_N.mp3'],
                preload: 'auto'
            }],
            symbolInstances: [
            {
    ...
    states: {
        "Base State": {
            "${_txt}": [
                ["style", "top", '121px'],
                ["style", "clip", [87.999755859375,1220,89.33349609375,620], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_Stage}": [
            ...
            "${_fondo}": [
                ...
                ["transform", "scaleY", '0'],
                ["transform", "scaleX", '0'],
                ["style", "clip", [126.539794921875,600,560.00048828125,155.12136840820312], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ],
                ["style", "left", '0px'],
            ...
            "${_icono}": [
                ["style", "top", '178px'],
                ["transform", "scaleY", '0'],
                ["style", "-webkit-transform-origin", [6.41,21.36], {valueTemplate:'@@0@@% @@1@@%'} ],
                ["style", "-moz-transform-origin", [6.41,21.36],{valueTemplate:'@@0@@% @@1@@%'}],
                ["style", "-ms-transform-origin", [6.41,21.36],{valueTemplate:'@@0@@% @@1@@%'}],
                ["style", "msTransformOrigin", [6.41,21.36],{valueTemplate:'@@0@@% @@1@@%'}],
                ["style", "-o-transform-origin", [6.41,21.36],{valueTemplate:'@@0@@% @@1@@%'}],
                ["style", "transform-origin", [6.41,21.36],{valueTemplate:'@@0@@% @@1@@%'}],
                ["style", "display", 'none'],
                ["style", "left", '94px'],
                ["style", "clip", [50.707218170166016,164.6641387939453,201.90220642089844,13.286531448364258], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ],
                ["transform", "scaleX", '0']
            ],
            "${_per}": [
                ["style", "top", '59px'],
                ...
                ["style", "left", '98px'],
                ["style", "clip", [-33.73828125,587.2745971679688,636.5899047851562,-29.78448486328125], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ]
        }
    },
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                { id: "eid2095", tween: [ "transform", "${_per}", "scaleX", '0.54579', { fromValue: '0'}], position: 0, duration: 750, easing: "swing" },
                ...
                { id: "eid2097", tween: [ "transform", "${_per}", "scaleY", '0.54579', { fromValue: '0'}], position: 0, duration: 750, easing: "swing" },
                { id: "eid2124", tween: [ "transform", "${_bt_audio}", "scaleX", '1', { fromValue: '0'}], position: 1000, duration: 500, easing: "swing" },
                { id: "eid2288", tween: [ "style", "${_icono}", "clip", [50.707218170166016,164.6641387939453,201.90220642089844,13.286531448364258], { valueTemplate: 'rect(@@0@@px @@1@@px @@2@@px @@3@@px)', fromValue: [50.707218170166016,164.6641387939453,201.90220642089844,13.286531448364258]}], position: 15000, duration: 0 },
                { id: "eid2289", tween: [ "style", "${_icono}", "display", 'block', { fromValue: 'none'}], position: 500, duration: 0, easing: "swing" },
                { id: "eid2286", tween: [ "transform", "${_icono}", "scaleX", '0.94946', { fromValue: '0'}], position: 500, duration: 750, easing: "easeOutBack" },
                { id: "eid2175", tween: [ "style", "${_fondo}", "clip", [126.539794921875,600,560.00048828125,155.12136840820312], { valueTemplate: 'rect(@@0@@px @@1@@px @@2@@px @@3@@px)', fromValue: [126.539794921875,600,560.00048828125,155.12136840820312]}], position: 15000, duration: 0 },
                { id: "eid2122", tween: [ "style", "${_txt}", "clip", [85.333251953125,1220,509.33349609375,620], { valueTemplate: 'rect(@@0@@px @@1@@px @@2@@px @@3@@px)', fromValue: [87.999755859375,1220,89.33349609375,620]}], position: 1000, duration: 1000, easing: "swing" },
                { id: "eid2287", tween: [ "transform", "${_icono}", "scaleY", '0.94946', { fromValue: '0'}], position: 500, duration: 750, easing: "easeOutBack" }            ]
        }
    }
},
"Hot_Spot": {
            ...
            dom: [
                {
                    type: 'image',
                    id: 'pelo',
                    rect: ['-716px', '-597px', '1117px', '1000px', 'auto', 'auto'],
                ...
                },
                {
                    ...
                    id: 'DER',
                    stroke: [0, 'rgb(0, 0, 0)', 'none'],
                    rect: ['257px', '266px', '306px', '204px', 'auto', 'auto'],
                ...
                },
                {
                    ...
                    c: [
                    {
                        type: 'image',
                        id: 'piernas',
                        rect: ['110px', '-31px', '1117px', '1000px', 'auto', 'auto'],
                    ...
                    },
                    {
                        type: 'image',
                        id: 'tronco',
                        rect: ['110px', '9px', '1117px', '1000px', 'auto', 'auto'],
                    ...
                    },
                    {
                        ...
                        id: 'IZQ',
                        stroke: [0, 'rgb(0, 0, 0)', 'none'],
                        rect: ['125px', '178px', '118px', '430px', 'auto', 'auto'],
                        fill: ['rgba(192,192,192,0)'],
                        c: [
                        {
                            type: 'rect',
                ...
                },
                {
                    ...
                    rect: ['-436px', '-519px', '1117', '1000', 'auto', 'auto'],
                    c: [
                    {
                        type: 'image',
                        id: 'cabeza',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid2350", tween: [ "style", "${_cabeza}", "-moz-transform-origin", [61.68,76.97], { valueTemplate: '@@0@@% @@1@@%', fromValue: [61.68,76.97]}], position: 1000, duration: 0 },
                { id: "eid2351", tween: [ "style", "${_cabeza}", "-ms-transform-origin", [61.68,76.97], { valueTemplate: '@@0@@% @@1@@%', fromValue: [61.68,76.97]}], position: 1000, duration: 0 },
                { id: "eid2352", tween: [ "style", "${_cabeza}", "msTransformOrigin", [61.68,76.97], { valueTemplate: '@@0@@% @@1@@%', fromValue: [61.68,76.97]}], position: 1000, duration: 0 },
                { id: "eid2353", tween: [ "style", "${_cabeza}", "-o-transform-origin", [61.68,76.97], { valueTemplate: '@@0@@% @@1@@%', fromValue: [61.68,76.97]}], position: 1000, duration: 0 },
                { id: "eid2354", tween: [ "style", "${_cabeza}", "transform-origin", [61.68,76.97], { valueTemplate: '@@0@@% @@1@@%', fromValue: [61.68,76.97]}], position: 1000, duration: 0 },
                ...
                { id: "eid2355", tween: [ "style", "${_pelo}", "-moz-transform-origin", [86.75,76.97], { valueTemplate: '@@0@@% @@1@@%', fromValue: [86.75,76.97]}], position: 1000, duration: 0 },
                { id: "eid2356", tween: [ "style", "${_pelo}", "-ms-transform-origin", [86.75,76.97], { valueTemplate: '@@0@@% @@1@@%', fromValue: [86.75,76.97]}], position: 1000, duration: 0 },
                { id: "eid2357", tween: [ "style", "${_pelo}", "msTransformOrigin", [86.75,76.97], { valueTemplate: '@@0@@% @@1@@%', fromValue: [86.75,76.97]}], position: 1000, duration: 0 },
                { id: "eid2358", tween: [ "style", "${_pelo}", "-o-transform-origin", [86.75,76.97], { valueTemplate: '@@0@@% @@1@@%', fromValue: [86.75,76.97]}], position: 1000, duration: 0 },
                { id: "eid2359", tween: [ "style", "${_pelo}", "transform-origin", [86.75,76.97], { valueTemplate: '@@0@@% @@1@@%', fromValue: [86.75,76.97]}], position: 1000, duration: 0 },
                ...
                { id: "eid2360", tween: [ "style", "${_ojos}", "-moz-transform-origin", [26.49,198.01], { valueTemplate: '@@0@@% @@1@@%', fromValue: [26.49,198.01]}], position: 1000, duration: 0 },
                { id: "eid2361", tween: [ "style", "${_ojos}", "-ms-transform-origin", [26.49,198.01], { valueTemplate: '@@0@@% @@1@@%', fromValue: [26.49,198.01]}], position: 1000, duration: 0 },
                { id: "eid2362", tween: [ "style", "${_ojos}", "msTransformOrigin", [26.49,198.01], { valueTemplate: '@@0@@% @@1@@%', fromValue: [26.49,198.01]}], position: 1000, duration: 0 },
                { id: "eid2363", tween: [ "style", "${_ojos}", "-o-transform-origin", [26.49,198.01], { valueTemplate: '@@0@@% @@1@@%', fromValue: [26.49,198.01]}], position: 1000, duration: 0 },
                { id: "eid2364", tween: [ "style", "${_ojos}", "transform-origin", [26.49,198.01], { valueTemplate: '@@0@@% @@1@@%', fromValue: [26.49,198.01]}], position: 1000, duration: 0 },
                ...
                { id: "eid2365", tween: [ "style", "${_boca}", "-moz-transform-origin", [14.44,98.01], { valueTemplate: '@@0@@% @@1@@%', fromValue: [14.44,98.01]}], position: 1000, duration: 0 },
                { id: "eid2366", tween: [ "style", "${_boca}", "-ms-transform-origin", [14.44,98.01], { valueTemplate: '@@0@@% @@1@@%', fromValue: [14.44,98.01]}], position: 1000, duration: 0 },
                { id: "eid2367", tween: [ "style", "${_boca}", "msTransformOrigin", [14.44,98.01], { valueTemplate: '@@0@@% @@1@@%', fromValue: [14.44,98.01]}], position: 1000, duration: 0 },
                { id: "eid2368", tween: [ "style", "${_boca}", "-o-transform-origin", [14.44,98.01], { valueTemplate: '@@0@@% @@1@@%', fromValue: [14.44,98.01]}], position: 1000, duration: 0 },
                { id: "eid2369", tween: [ "style", "${_boca}", "transform-origin", [14.44,98.01], { valueTemplate: '@@0@@% @@1@@%', fromValue: [14.44,98.01]}], position: 1000, duration: 0 },
