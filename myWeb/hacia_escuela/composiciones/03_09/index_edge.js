...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                text: "Después de estudiar la definición de fluidez creativa, se pueden generar varias conclusiones. Señala cuál de las siguientes es una conclusión falsa sobre la fluidez creativa:<br>",
                align: "left",
    ...
    states: {
        "Base State": {
            ...
            "${_per}": [
                ...
                ["style", "left", '831px'],
                ["style", "clip", [0,556,817.1497192382813,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_bad19}": [
                ["style", "top", '177px'],
                ["style", "height", '20px'],
