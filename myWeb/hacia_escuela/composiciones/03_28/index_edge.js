...
"slide_1": {
    ...
    content: {
            dom: [
                ...
                {
                    rect: ['0', '98px', '1304px', '596px', 'auto', 'auto'],
                    id: 'C_txt',
                    type: 'image',
                ...
                {
                    rect: ['0', '179px', '1304px', '596px', 'auto', 'auto'],
                    id: 'B_txt',
                    type: 'image',
                    clip: ['rect(0px 280px 138.66650390625px 0px)'],
                    fill: ['rgba(0,0,0,0)', 'images/ABC02.png', '0px', '0px']
                ...
                {
                    rect: ['0', '281px', '1304px', '596px', 'auto', 'auto'],
                    id: 'A_txt',
                    type: 'image',
                    clip: ['rect(0px 280px 138.66650390625px 0px)'],
                    fill: ['rgba(0,0,0,0)', 'images/ABC02.png', '0px', '0px']
                ...
                {
                    rect: ['0px', '281px', '1304px', '596px', 'auto', 'auto'],
                    type: 'image',
                    id: 'a',
                    display: 'none',
                ...
                {
                    rect: ['0px', '179px', '1304px', '596px', 'auto', 'auto'],
                    type: 'image',
                    id: 'b',
                    display: 'none',
                    clip: ['rect(229.33349609375px 282.6669921875px 336px 0px)'],
                    fill: ['rgba(0,0,0,0)', 'images/ABC03.png', '0px', '0px']
                },
                {
                    rect: ['0px', '98px', '1304px', '596px', 'auto', 'auto'],
                    type: 'image',
                    id: 'c',
                    display: 'none',
                    clip: ['rect(396.00048828125px 282.6669921875px 502.6669921875px 0px)'],
                    fill: ['rgba(0,0,0,0)', 'images/ABC03.png', '0px', '0px']
                },
                {
                    rect: ['192px', '515px', '919px', '79px', 'auto', 'auto'],
                    cursor: ['pointer'],
                    type: 'rect',
                    id: 'hsC',
                    stroke: [0, 'rgb(0, 0, 0)', 'none'],
                    clip: ['rect(-18.66650390625px 919px 79px 0px)'],
                    fill: ['rgba(192,192,192,0)']
                },
                {
                    rect: ['192px', '413px', '919px', '99px', 'auto', 'auto'],
                    type: 'rect',
                    id: 'hsB',
                    stroke: [0, 'rgb(0, 0, 0)', 'none'],
                    cursor: ['pointer'],
                ...
                {
                    rect: ['192px', '332px', '919px', '79px', 'auto', 'auto'],
                    type: 'rect',
                    id: 'hsA',
                    stroke: [0, 'rgb(0, 0, 0)', 'none'],
                    cursor: ['pointer'],
    ...
    states: {
        "Base State": {
            "${_b}": [
                ["style", "top", '179px'],
                ["style", "display", 'none'],
                ["style", "clip", [229.33349609375,282.6669921875,336,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ],
                ["style", "left", '0px']
            ],
            "${_hsC}": [
                ["style", "top", '515px'],
                ...
                ["style", "height", '79px'],
                ["style", "left", '192px'],
                ["style", "clip", [-18.66650390625,919,79,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ],
                ["style", "width", '919px']
            ],
            "${_a}": [
                ["style", "top", '281px'],
            ...
            "${_B_txt}": [
                ...
                ["transform", "scaleY", '0'],
                ["transform", "scaleX", '0'],
                ["style", "clip", [223,280,338.33349609375,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ],
            ...
            "${_c}": [
                ...
                ["style", "display", 'none'],
                ["style", "left", '0px'],
                ["style", "clip", [396.00048828125,282.6669921875,502.6669921875,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_ABC01}": [
                ["style", "top", '-34px'],
                ["style", "opacity", '0']
            ...
            "${_C_txt}": [
                ...
                ["transform", "scaleY", '0'],
                ["transform", "scaleX", '0'],
                ["style", "clip", [390,280,504.66650390625,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ],
    ...
    timelines: {
        "Default Timeline": {
            ...
            autoPlay: true,
            timeline: [
                { id: "eid2492", tween: [ "transform", "${_B_txt}", "scaleX", '1', { fromValue: '0'}], position: 1500, duration: 500, easing: "easeOutBack" },
                { id: "eid2483", tween: [ "transform", "${_A_txt}", "scaleX", '1', { fromValue: '0'}], position: 750, duration: 500, easing: "easeOutBack" },
                { id: "eid2485", tween: [ "transform", "${_A_txt}", "scaleY", '1', { fromValue: '0'}], position: 750, duration: 500, easing: "easeOutBack" },
                { id: "eid2533", tween: [ "style", "${_b}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
                { id: "eid2489", tween: [ "style", "${_C_txt}", "clip", [389,1303,504.66650390625,0], { valueTemplate: 'rect(@@0@@px @@1@@px @@2@@px @@3@@px)', fromValue: [390,280,504.66650390625,0]}], position: 2750, duration: 750, easing: "easeOutQuad" },
                { id: "eid2494", tween: [ "style", "${_B_txt}", "clip", [225,1303,337.33349609375,0], { valueTemplate: 'rect(@@0@@px @@1@@px @@2@@px @@3@@px)', fromValue: [223,280,338.33349609375,0]}], position: 2000, duration: 750, easing: "easeOutQuad" },
                { id: "eid2532", tween: [ "style", "${_c}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
                { id: "eid2476", tween: [ "style", "${_ABC01}", "opacity", '1', { fromValue: '0'}], position: 0, duration: 750, easing: "easeOutQuad" },
                { id: "eid2493", tween: [ "transform", "${_B_txt}", "scaleY", '1', { fromValue: '0'}], position: 1500, duration: 500, easing: "easeOutBack" },
                { id: "eid2486", tween: [ "style", "${_A_txt}", "clip", [0,1303,138.66650390625,0], { valueTemplate: 'rect(@@0@@px @@1@@px @@2@@px @@3@@px)', fromValue: [0,280,138.66650390625,0]}], position: 1250, duration: 750, easing: "easeOutQuad" },
                { id: "eid2487", tween: [ "transform", "${_C_txt}", "scaleX", '1', { fromValue: '0'}], position: 2250, duration: 500, easing: "easeOutBack" },
                { id: "eid2475", tween: [ "style", "${_ABC01}", "top", '29px', { fromValue: '-34px'}], position: 0, duration: 750, easing: "easeOutQuad" },
                { id: "eid2490", tween: [ "transform", "${_C_txt}", "scaleY", '1', { fromValue: '0'}], position: 2250, duration: 500, easing: "easeOutBack" },
                { id: "eid2534", tween: [ "style", "${_a}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 }            ]
        }
    }
},
"bt_ayuda": {
