...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                type: 'image',
                rect: ['5px', '72px','1304px','596px','auto', 'auto'],
                clip: ['rect(301.33349609375px 1264px 417.33349609375px 675.99951171875px)'],
                fill: ["rgba(0,0,0,0)",im+"cont.png",'0px','0px']
            },
            {
                id: 'txt2',
                type: 'image',
                rect: ['5px', '72px','1304px','596px','auto', 'auto'],
                clip: ['rect(176.000244140625px 1265.3330078125px 274.6669921875px 676.00048828125px)'],
                fill: ["rgba(0,0,0,0)",im+"cont.png",'0px','0px']
            },
            {
                id: 'txt1',
            ...
            },
            {
                ...
                fill: ["rgba(0,0,0,0)",im+"cont.png",'0px','57.3330078125px']
            },
            {
                id: 'bt_audio',
                type: 'rect',
            ...
            },
            {
                ...
                type: 'audio',
                tag: 'audio',
                rect: ['1465', '206','320px','45px','auto', 'auto'],
                source: ['media/F1_E3_D17_N.mp3'],
                preload: 'auto'
            }],
            symbolInstances: [
            {
    ...
    states: {
        "Base State": {
            ...
            "${_txt3}": [
                ...
                ["style", "opacity", '0'],
                ["style", "left", '5px'],
                ["style", "clip", [301.33349609375,1264,417.33349609375,675.99951171875], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_per}": [
                ["style", "top", '-93px'],
            ...
            "${_txt2}": [
                ...
                ["style", "opacity", '0'],
                ["style", "left", '5px'],
                ["style", "clip", [176.000244140625,1265.3330078125,274.6669921875,676.00048828125], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_globo}": [
                ["style", "top", '72px'],
                ["style", "-webkit-transform-origin", [19.4,32.1], {valueTemplate:'@@0@@% @@1@@%'} ],
                ["style", "-moz-transform-origin", [19.4,32.1],{valueTemplate:'@@0@@% @@1@@%'}],
                ["style", "-ms-transform-origin", [19.4,32.1],{valueTemplate:'@@0@@% @@1@@%'}],
                ["style", "msTransformOrigin", [19.4,32.1],{valueTemplate:'@@0@@% @@1@@%'}],
                ["style", "-o-transform-origin", [19.4,32.1],{valueTemplate:'@@0@@% @@1@@%'}],
                ["style", "transform-origin", [19.4,32.1],{valueTemplate:'@@0@@% @@1@@%'}],
                ["transform", "scaleY", '0'],
                ["style", "clip", [29.333251953125,649.3330078125,282.66650390625,238.6669921875], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ],
                ["transform", "scaleX", '0'],
                ["style", "opacity", '0'],
                ["style", "background-position", [0,57.3330078125], {valueTemplate:'@@0@@px @@1@@px'} ],
                ["style", "left", '5px']
            ],
            "${_txt4}": [
                ["style", "top", '42px'],
