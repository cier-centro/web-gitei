...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'e',
                type: 'image',
                rect: ['47px', '95px','1304px','596px','auto', 'auto'],
            ...
            },
            {
                id: 'd',
                type: 'image',
                rect: ['47px', '111px','1304px','596px','auto', 'auto'],
                clip: ['rect(481.333251953125px 930.6669921875px 572px 32px)'],
                fill: ["rgba(0,0,0,0)",im+"opciones.png",'0px','0px']
            },
            {
                id: 'c',
                type: 'image',
                rect: ['47px', '127px','1304px','596px','auto', 'auto'],
            ...
            },
            {
                id: 'b',
                type: 'image',
                rect: ['47px', '143px','1304px','596px','auto', 'auto'],
            ...
            },
            {
                id: 'a',
                type: 'image',
                rect: ['47px', '159px','1304px','596px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'none',
                type: 'rect',
                rect: ['213px', '302px','35px','35px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'none',
                type: 'rect',
                rect: ['213px', '379px','35px','35px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on"
            },
            {
                ...
                display: 'none',
                type: 'rect',
                rect: ['213px', '454px','35px','35px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on"
            },
            {
                ...
                display: 'none',
                type: 'rect',
                rect: ['213px', '531px','35px','35px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on"
            },
            {
                ...
                display: 'none',
                type: 'rect',
                rect: ['213px', '607px','35px','35px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on"
            },
            {
                ...
                display: 'block',
                type: 'text',
                rect: ['148px', '205px','869px','52px','auto', 'auto'],
                text: "Anteriormente viste una situación donde Santiago ayudaba a su equipo de fútbol. Se puede decir que las iniciativas de Santiago para continuar con el entrenamiento del equipo de fútbol son una evidencia de fluidez creativa porque:<br>",
                align: "left",
    ...
    states: {
        "Base State": {
            ...
            "${_c}": [
                ["style", "top", '127px'],
                ["style", "opacity", '0'],
                ["style", "clip", [305.33349609375,933.3330078125,390.666748046875,32], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ],
                ["style", "left", '287px']
            ],
            "${_bt_solucion}": [
                ["style", "top", '230px'],
            ...
            "${_b}": [
                ["style", "top", '143px'],
                ["style", "opacity", '0'],
                ["style", "clip", [208.00048828125,932,298.666748046875,33.33349609375], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ],
                ["style", "left", '287px']
            ],
            "${_ok20}": [
                ["style", "top", '177px'],
            ...
            "${_d}": [
                ...
                ["style", "opacity", '0'],
                ["style", "left", '287px'],
                ["style", "clip", [394.666748046875,930.6669921875,482.66650390625,32], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_checkbox_3}": [
                ["color", "background-color", 'rgba(255,255,255,0.00)'],
                ["style", "border-top-left-radius", [5,5], {valueTemplate:'@@0@@px @@1@@px'} ],
            ...
            "${_e}": [
                ...
                ["style", "opacity", '0'],
                ["style", "left", '245px'],
                ["style", "clip", [490.66674804688,930.6669921875,572,32], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_bad10}": [
                ["style", "top", '177px'],
                ["style", "display", 'none'],
            ...
            "${_a}": [
                ["style", "top", '159px'],
                ["style", "opacity", '0'],
                ["style", "clip", [119.99951171875,936,210.666748046875,33.33349609375], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ],
                ["style", "left", '287px']
            ],
            "${_bad6}": [
                ["style", "top", '177px'],
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid1379", tween: [ "style", "${_e}", "left", '47px', { fromValue: '245px'}], position: 1000, duration: 500 },
                ...
                { id: "eid1377", tween: [ "style", "${_c}", "left", '47px', { fromValue: '47px'}], position: 1000, duration: 0 },
                ...
                { id: "eid1388", tween: [ "style", "${_checkbox_5}", "display", 'block', { fromValue: 'none'}], position: 1250, duration: 0 },
                ...
                { id: "eid1381", tween: [ "style", "${_e}", "opacity", '1', { fromValue: '0'}], position: 1000, duration: 500 },
                ...
                { id: "eid1342", tween: [ "style", "${_d}", "left", '47px', { fromValue: '287px'}], position: 750, duration: 500 },
                { id: "eid1378", tween: [ "style", "${_d}", "left", '47px', { fromValue: '47px'}], position: 1250, duration: 0 },
                { id: "eid1344", tween: [ "style", "${_b}", "left", '47px', { fromValue: '287px'}], position: 250, duration: 500 },
                { id: "eid1375", tween: [ "style", "${_b}", "left", '47px', { fromValue: '47px'}], position: 750, duration: 0 },
                ...
                { id: "eid1376", tween: [ "style", "${_a}", "left", '47px', { fromValue: '47px'}], position: 500, duration: 0 },
