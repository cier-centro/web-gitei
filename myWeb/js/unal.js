...
jQuery(document).ready(function($) {
    ...
    function serviceMenuStatus() {
        ...
        if ($(".indicator", "#unalServices").hasClass("active")) {
            $s.css({
                right: 0
            });
        } else {
            $s.css({
                right: parseInt($("#unalServices").width()) * -1
            });
        }
    }
    $(".indicator", "#unalServices").click(function() {
    ...
    $(window).resize(function() {
        ...
        if ($(window).width() > 767) {
            ...
            $(".indicator", "#unalServices").removeClass("active");
        }
    });
    $("#unalServices").css({
        right: parseInt($("#unalServices").width()) * -1
